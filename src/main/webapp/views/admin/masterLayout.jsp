...
<style>
tr:hover {
	background-color: #ecf0f1; /* Màu secondary */
}
</style>
...
<body id="page-top" ng-app="myApp" ng-controller="Ctrls">
	<!--include nav -->
	<jsp:include page="/views/admin/partials/nav.jsp"></jsp:include>
	...
	<div id="wrapper">
		...
		<jsp:include page="/views/admin/partials/sidebar.jsp"></jsp:include>
		...
		<div id="content-wrapper">
			...
			<!--include footer -->
			<jsp:include page="/views/admin/partials/footer.jsp"></jsp:include>
		</div>
	...
	<jsp:include page="/views/admin/partials/scrollToTop.jsp"></jsp:include>
	<jsp:include page="/views/admin/partials/logoutModal.jsp"></jsp:include>
	<!-- Modal show message-->
	<jsp:include page="/views/admin/partials/showMessage.jsp"></jsp:include>
