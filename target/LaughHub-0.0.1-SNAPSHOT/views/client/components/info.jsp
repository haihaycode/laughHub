		...
		<nav class="navbar navbar-expand-lg navbar-light">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mr-auto">
					<li class="nav-item active"><a class="nav-link " href="info">Thông
							tin cá nhân </a></li>
					<li class="nav-item "><a class="nav-link " href="changepass">Đổi
							mật khẩu</a></li>
				...
				<div class="col-md-5">
					<div class="login-main">
						<div class="text-center mb-5 login-main-left-header pt-4">
							...
							<h5 class="mt-3 mb-1 fw-bold fs-5">Cập nhật thông tin cá
								nhân</h5>
						...
						<form class="mx-1 mx-md-4" action="" method="post"
							...
							<div class="d-flex flex-row align-items-center mb-4">
								...
								<div class="form-outline flex-fill mb-0">
									<label class="form-label" for="form3Example3c1">Tài
										Khoản</label><input type="text" name="id" value="${user.id}"
							...
							<div class="d-flex flex-row align-items-center mb-4">
								...
								<div class="form-outline flex-fill mb-0">
									<label class="form-label" for="form3Example3c2"> Họ và
							...
							<div class="d-flex flex-row align-items-center mb-4">
								...
								<div class="form-outline flex-fill mb-0">
									<label class="form-label" for="form3Example4c5"> Email</label>
							...
							<div class="d-flex flex-row align-items-center mb-4">
								...
								<div class="form-outline flex-fill mb-0">
									<label class="form-label" for="imageUpload">Chọn ảnh</label> <input
						...
						<div class="text-center mt-5">
							<p class="light-gray">
								Bạn muốn đổi mật khẩu tài khoản ? <a href="changepass">Đổi
									mật khẩu</a>
							</p>
						</div>
					</div>
