			...
			<div class="row no-gutters">
				<div class="col-md-12">
					<div class="login-main row">
						...
						<c:if test="${not empty videosHistoy}">
							<c:forEach items="${videosHistoy}" var="video">
								...
								<div class="col-xl-3 col-sm-6 mb-3 remove-itemt"
									style="height: 100%">
										...
										<div class="video-card-body">
											...
											<div class="info">
												${video.views} <fmt:message key="menu.view"/> |<i class="likeCount">
													${video.favorites.size()}</i> <fmt:message key="menu.like"/> &nbsp;<i
											...
											<div
												...
												<div class="actions">
													<button class="btn btn-primary"
														ng-click="Unlike('${video.id }',$event)">
